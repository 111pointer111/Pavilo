...
已接受（2026-09-20）；Play 宿主在主分支已实现，尚未发布。

2026-09-21 补充：[ADR-0008](0008-embeddable-composable-chat.md) 更新阶段安排，Play 宿主纳入 v1.3 收口，官方狼人杀与身份/嵌入并行，目标 v1.6 完成、v2 前交付。下文 v1.5 是原规划背景。频道绑定、独立玩法页与现有契约继续有效；未来统一嵌入宿主不等于改用聊天气泡或玩法市场。
