...
| [0008](0008-embeddable-composable-chat.md) | 独立与嵌入共用的可组装聊天能力 | 已接受；嵌入预览已随 v1.6.0 发布，SDK 仍待实施 | 2026-09-21 |
...
ADR-0003 的 trusted script 加载模型仍有效，旧版本安排与示意 API 不代表当前实现。ADR-0004–0007 已随 v1.3.0 落地；0009 / 0010 已随 v1.4.0 落地；0011 已随 v1.5.0 发布。0008 的嵌入预览已随 v1.6.0 发布，SDK 仍待实施。0006 的已落地 Play 契约继续兼容维护，不另开商店。ADR 的“已接受”表示决策状态；当前阶段以路线图为准。
