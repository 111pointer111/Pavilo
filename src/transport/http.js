...
const CLIENT_FILES = new Set(['protocol', 'connection', 'state', 'pending', 'messages', 'composer', 'mentions', 'images', 'overlays', 'notifications', 'error-states', 'performance', 'app'].map((name) => `/client/${name}.js`));
